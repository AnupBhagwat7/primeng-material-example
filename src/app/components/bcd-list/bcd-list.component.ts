...
@Component({
  selector: 'bcd-list',
  templateUrl: './bcd-list.component.html',
  styleUrls: ['./bcd-list.component.css']
})
export class BcdListComponent implements OnInit {
  ...
  private createColumnDefs() {
      return [
          ...
          {headerName: 'Email', field: 'email', filter: true,sortable:true, editable:true},
